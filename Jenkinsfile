        ...
        stage('nexus artifact uploader'){
            steps{
                script{
                    ...
                    nexusArtifactUploader artifacts: [[artifactId: 'devops-integration', classifier: '', file: 'target/devops-integration.jar', type: 'jar']], credentialsId: 'nexus-creds', groupId: 'com.javatechie', nexusUrl: '3.6.39.254:8081', nexusVersion: 'nexus3', protocol: 'http', repository: readrepo, version: readversion
                ...
                script{
                    dir('kubernetes/') {
                        withCredentials([usernamePassword(credentialsId: 'nexushelm', passwordVariable: 'npassword', usernameVariable: 'nusername')]) {
                            ...
                            curl -u $nusername:$npassword http://3.6.39.254:8081/repository/helm-repo/ --upload-file myapp-${helmversion}.tgz -v
                            '''
                        }
                    }
                }
